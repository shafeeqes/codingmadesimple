...
Split number n in two numbers x and y such that n=x*y where x contains only prime factors in range 2 <= x <= n(1/3)
and y deals with higher prime factors greater than n(1/3).
...
Note that, we have only these three cases for calculating factors of y since there can be at max two prime factors of y. If it would have
