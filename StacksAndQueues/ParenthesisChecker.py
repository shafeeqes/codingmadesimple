"""
Given an expression string exp. Examine whether the pairs and the 
...
cases.  Each test case consists of a string of expression, in a separate line.
